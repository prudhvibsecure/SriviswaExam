...
public class Database extends SQLiteOpenHelper {
    ...
    private String EXAM_TABLE = "CREATE TABLE EXAM(exam_id INTEGER, exam_name TEXT, course TEXT, subjects TEXT, no_of_questions TEXT, marks_per_question TEXT, negative_marks TEXT, duration TEXT)";
    ...
    private String ASSIGNMENT_TABLE = "CREATE TABLE ASSIGNMENT(assignment_id INTEGER, assignment_name TEXT, subject TEXT, course TEXT, course_name TEXT, section TEXT, lessons TEXT, topics TEXT, exam_date TEXT, from_time TEXT, to_time TEXT, duration TEXT, no_of_questions TEXT, marks_per_question TEXT, questions TEXT)";
