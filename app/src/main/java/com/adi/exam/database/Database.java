...
public class Database extends SQLiteOpenHelper {
    ...
    private String STUDENT_TABLE = "CREATE TABLE STUDENTS(student_id INTEGER, student_name TEXT, password TEXT, application_no TEXT, roll_no TEXT, class_id TEXT, course_name TEXT, program_name TEXT, section TEXT, parent_phone_no TEXT, year TEXT, status TEXT);";
