...
public class JIPMERSemplates extends ParentFragment implements View.OnClickListener {
    ...
    public static JIPMERSemplates newInstance(String examTypeId, String examName) {
