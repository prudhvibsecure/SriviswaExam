...
public class JEEemplates extends ParentFragment implements View.OnClickListener {
    ...
    public static JEEemplates newInstance(String examTypeId, String examName) {
