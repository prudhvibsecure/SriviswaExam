...
public class AIIMSemplates extends ParentFragment implements View.OnClickListener {
    ...
    public static AIIMSemplates newInstance(String examTypeId, String examName) {
