...
public class KVPYTemplates extends ParentFragment implements View.OnClickListener {
    ...
    public static KVPYTemplates newInstance(String examTypeId, String examName) {
